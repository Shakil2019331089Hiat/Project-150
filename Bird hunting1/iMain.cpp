...
void iDraw()
{
	...
	if (start == false && dev == false && instruction == false)
	{
		...
		if (pause)
		{
			iText(865, 700, "CONTINUE", GLUT_BITMAP_TIMES_ROMAN_24);
		}
		else
		{
			iText(895, 700, "START", GLUT_BITMAP_TIMES_ROMAN_24);
		}
		...
		iSetColor(0, 255, 255);
		iText(835, 530, "ABOUT  GAME", GLUT_BITMAP_TIMES_ROMAN_24);
		
		iSetColor(0,  0, 0);
		iFilledRectangle(770, 300, 350, 80);
		iSetColor(255, 0, 255);
		iText(800, 330, "ABOUT  DEVELOPER", GLUT_BITMAP_TIMES_ROMAN_24);
	...
	else if (instruction == true)
	{
		...
		iSetColor(0, 255, 0);
		iText(100, 800, "GAME INFO and CONTROL: The game is developed using only C++ programming language and the title of the game is \"Bird Hunting\". In this ", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(100, 750, "game you can control your bow by right and left key and keep it in threee different direction. You get a primary arrow attached with bow ", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(100, 700, "and 5 more arrow beside the bow. You can adjust your bow string according to your need of speed. To do this you have to use up and down ", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(100, 650, "key before release your arrow. You will release your arrow by using \"R\" key. ", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(100, 550, "REWARDS and OPPORTUNITIES : You will be given specific number of birds locating after \"birds remaining\" term initially.  If you will ", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(100, 500, "able to hunt it or it will disappeare then it means 1 bird has gone. By hunting one general bird (Blue) you will get 1 points. By hunting ", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(100, 450, "a special gold bird (Golden) you will get  extra 5 points. If you hunt a devil bird (Red) you will lost an arrow with no benefit. If you ", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(100, 400, "can make a headshot you will get extra 5 points. Remember that, even headshot is not applicable to Devil bird. The game will over when ", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(100, 350, "you will have no arrow left or no bird remaining.", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(100, 300, "", GLUT_BITMAP_TIMES_ROMAN_24);
	...
	else if (start == true)
	{
		...
		if (special_bird == gold)
		{
			...
			iCircle(105, 600, 67);
			iSetColor(255, 255, 0);
			iText(55, 589, "Golden!!", GLUT_BITMAP_TIMES_ROMAN_24);
		...
		else if (special_bird == devil)
		{
			...
			iCircle(105, 600, 67);
			iSetColor(255, 0, 0);
			iText(45, 589, "Devil Bird", GLUT_BITMAP_TIMES_ROMAN_24);
		...
		iText(1710, 1010, score[kill], GLUT_BITMAP_TIMES_ROMAN_24);

		if (num_arrow > -1)
		{
			iText(50, 1010, "Birds remaininng : ", GLUT_BITMAP_TIMES_ROMAN_24);
			iText(290, 1010, score[bird_cycle - bird_gone], GLUT_BITMAP_TIMES_ROMAN_24);
			iText(600, 1010, "Arrow remaininng : ", GLUT_BITMAP_TIMES_ROMAN_24);
			iText(860, 1010, score[num_arrow], GLUT_BITMAP_TIMES_ROMAN_24);
...
{
	cout << mx << my << endl;
	if (mx > 677 && mx < 835 && my > 760 && my < 820 && start == false && instruction == false && dev == false)
	{
		box = 1;
	}
	else if (mx > 635 && mx < 875 && my > 630 && my < 690 && start == false && instruction == false && dev == false)
	{
		box = 2;
	}
	else if (mx > 620 && mx < 900 && my > 480 && my < 540 && start == false && instruction == false && dev == false)
	{
		box = 3;
	}
	else
...
void iMouse(int button, int state, int mx, int my)
{
	...
	if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN)
	{
		...
		else if (mx > 70 && mx < 165 && my > 315 && my < 350 && start == true && instruction == false && dev == false)
		{
			pause = true;
			start = false;
			instruction = false;
		...
		else if (mx > 1400 && mx < 1475 && my > 315 && my < 350 && start == true && instruction == false && dev == false)
		{
		...
		else if (mx > 1357 && mx < 1523 && my > 300 && my < 365 && start == false && instruction == true && dev == false)
		{
		...
		else if (mx > 1357 && mx < 1523 && my > 300 && my < 365 && start == false && instruction == false && dev == true)
		{
